...
const ProfileCard = ({
  ...
  const [isViewCounts, setIsViewCounts] = useState(Boolean);
  ...
  const playRandomPodcast = () => {
    ...
    if (randomPodcast?._id === selectedPodcast._id) {
      setIsViewCounts(false);
    } else {
      setIsViewCounts(true);
    }
  ...
  useEffect(() => {
    if (randomPodcast) {
      if (isViewCounts) updatePodcastViews({ podcastId: randomPodcast._id });
  ...
  }, [randomPodcast, isViewCounts, setAudio, updatePodcastViews]);
